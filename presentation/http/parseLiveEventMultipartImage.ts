...
import { normalizeLiveEventMultipartBody } from "./normalizeLiveEventMultipartBody.js";
...
export const parseLiveEventMultipartImage: RequestHandler = (
  req,
  res,
  next
): void => {
  ...
  imageUpload.single("image")(req, res, (error: unknown) => {
    ...
    if (req.body && typeof req.body === "object") {
      normalizeLiveEventMultipartBody(req.body as Record<string, unknown>);
    }
