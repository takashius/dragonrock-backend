...
import { normalizeMultimediaMultipartBody } from "./normalizeMultimediaMultipartBody.js";
...
export const parseMultimediaMultipart: RequestHandler = (
  req,
  res,
  next
): void => {
  ...
  multimediaUpload.fields([
    ...
    if (req.body && typeof req.body === "object") {
      normalizeMultimediaMultipartBody(req.body as Record<string, unknown>);
    }
