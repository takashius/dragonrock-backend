...
import { normalizeServiceMultipartBody } from "./normalizeServiceMultipartBody.js";
...
export const parseServiceMultipartImage: RequestHandler = (
  req,
  res,
  next
): void => {
  ...
  imageUpload.single("image")(req, res, (error: unknown) => {
    ...
    if (req.body && typeof req.body === "object") {
      normalizeServiceMultipartBody(req.body as Record<string, unknown>);
    }
