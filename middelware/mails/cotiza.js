...
export default (titulo, mensaje, config, name, cotiza) => {
  const separator = `
    <!-- Start of separator -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" style="font-family: Helvetica, arial, sans-serif; font-size: 20px;color: ${config.configMail.colors.primary}" st-content="phone"  height="60">
                                                    Tel: ${config.phone}
                                                </td>
                                            </tr>
                                        </tbody>
